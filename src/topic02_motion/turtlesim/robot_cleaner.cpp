...
void rotate (double angular_speed, double relative_angle, bool clockwise) {
    ...
    // stop the robot after while loop terminates
    vel_msg.angular.z = 0;
    velocity_publisher.publish(vel_msg);
}
...
void setDesiredOrientation (double desired_angle_radians){
    double relative_angle_radius = desired_angle_radians - turtlesim_pose.theta;
    bool clockwise = ((relative_angle_radius < 0) ? true:false);
    rotate(degrees2radians(10), abs(relative_angle_radius), clockwise);
}
